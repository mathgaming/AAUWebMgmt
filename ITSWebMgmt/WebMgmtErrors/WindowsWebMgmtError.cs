...
namespace ITSWebMgmt.WebMgmtErrors
{
    ...
    public class IsTrashedØSS : ComputerWebMgmtError
    {
        public IsTrashedØSS(ComputerController computer) : base(computer)
        {
    ...
    public class IsTrashedWebMgmt : ComputerWebMgmtError
    {
