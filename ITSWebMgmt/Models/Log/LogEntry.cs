    ...
    public class LogEntry
    {
        ...
        public string GetDescription()
        {
            return Type switch
            {
                ...
                LogEntryType.AddedToCollection => $"Added {Arguments[0]} to {Arguments[1]}",
                LogEntryType.RemovedFromCollection => $"Removed {Arguments[0]} from {Arguments[1]}",
